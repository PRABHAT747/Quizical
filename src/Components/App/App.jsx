...
import './App.css'
 export default function App() {
   ...
   const[quesData,setData] = React.useState(null);
        ...
        React.useEffect( ()=>{getQuestions()},[newgame]) 
    ...
    return (
      <>
      {
       ...
       ( 
        ...
        data={quesData} 
        setData={setData} 
        Setnewgame ={Setnewgame} //passing the function as a prop to set in <Question/> Component
        newgame={newgame} // 
        />
        </div>
        ) 
    ...
    : (
      <div className='start'>
            <p className='intro'>React Quiz App</p>
            <button className='intro-button' onClick={handleclicked}>Start Quiz</button>
        </div>
    )      
 }
 </>
